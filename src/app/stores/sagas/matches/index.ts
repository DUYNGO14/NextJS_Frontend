...
function* callApiGetListMatches(
  action: ReturnType<typeof getMatchesAction>
...
function* callApiGetMatchDetail(
  action: ReturnType<typeof getMatchDetailAction>
): Generator<any, void, unknown> {
  try {
...
function* callApiCreateMatch(
  action: ReturnType<typeof createMatchAction>
): Generator<any, void, unknown> {
  try {
...
function* callApiUpdateMatch(
  action: ReturnType<typeof updateMatchAction>
): Generator<any, void, unknown> {
  try {
    const response: any = yield call(
      update,
...
function* callApiDeleteMatch(
  action: ReturnType<typeof deleteMatchAction>
): Generator<any, void, unknown> {
  try {
